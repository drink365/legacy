...
if owner == "父母":
    total_gift_value = current_land_value + current_house_value
    if transfer_type == "贈與房產":
        gift_tax, gift_formula = calc_gift_tax(total_gift_value)
    elif transfer_type == "留待繼承":
        estate_tax, estate_formula = calc_estate_tax(total_gift_value)

...
company = st.number_input("公司股權", min_value=0, value=5000, step=100)
real_estate = st.number_input("不動產", min_value=0, value=3000, step=100)
financial = st.number_input("金融資產（存款、股票、基金等）", min_value=0, value=2000, step=100)
insurance = st.number_input("保單", min_value=0, value=1000, step=100)
offshore = st.number_input("海外資產", min_value=0, value=500, step=100)
